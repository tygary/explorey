...
class GhostPrinter(object):
    ...
    def print_ghost(self, tag_uid):
        ...
        potential_ghosts = [ghost for ghost in GHOSTS if ghost["uid"] == tag_uid]
        ghost = potential_ghosts[0] if potential_ghosts else None
        if not ghost:
            ghost = UNKNOWN_GHOST
...
GHOSTS = [
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "07/13/1945",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "06/12/2011",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "01-23-2018 ",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "10/31/1999",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "01/03/19",
    ...
    {
        "timestamp": "2024-10-18T03:39:23.969Z",
        "description": "Rubix cube",
        "name": "Frustrated stash box",
        "origin": "Summerville, SC, USA",
        "fulfillment": 1,
        "purpose": 1,
        "owner": "Landsink Brooken age 11.",
        "discardReason": "I became the symbol of disappointment and failer",
        "factOne": " I wasn't broken—just misunderstood.",
        "factTwo": "I was ready to be a guardian of the illicit, but life has a way of mocking dreams.",
        "story": "In a cluttered warehouse on the outskirts of a forgotten city, I was born. My purpose a safe haven for secrets. My maker intended me for great things—small bags, hidden herbs, or wads of cash. I was ready to be a guardian of the illicit. A quiet accomplice to mischief. \n\nBut life has a way of mocking dreams.\n\nTaken from a shelf, the mother mistooke me for a regular puzzle toy. Before I knew it, I was unwrapped by a child, his eyes lighting up in excitement. The joy was short-lived. He twisted and turned my sides, but I wasn’t built for that. My locks refused to yield to his demands, and frustration brewed.\n\n“Mom, this one’s broken!” he yelled, jabbing at my corners. Every attempt to solve me left him more irritated, and I more resentful. Days passed, and I became the symbol of his disappointment. He didn't know I wasn't broken—just misunderstood.\n\nFinally, in a fit of rage, he threw me in the trash.\n\nSo here I am, buried under discarded scraps, my purpose never fulfilled. I was built to hold secrets, but instead, I became just another forgotten toy.",
        "recorded": "x",
        "column1": "Does not work"
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "03/13/1923",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "12/25/1997",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "03/11/2019",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "09/24/2024 ",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "09/07/2022",
    ...
    {
        "timestamp": "2024-10-18T04:00:15.795Z",
        "description": "black satin sleeping mask",
        "name": "Black Satin Sleeping Mask",
        "origin": "Braxton County, West Virginia, USA",
        "fulfillment": 5,
        "purpose": 7,
        "owner": "Jen Throckmorton",
        "discardReason": "Jen pulled me off her face in a panic when she encountered a monster while camping",
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "9/23/2019",
        "factOne": "Jen bought me so she could sleep in during a camping trip and she would have been much safer if she'd have kept me on all night",
        "factTwo": "I always dreamed someone glamorous would purchase me to help with their beauty rest but getting picked up and worn by a famous cryptid was actually pretty exciting",
        "story": "My primary memory of Jen Throckmorton is the screaming. Oh my God did that woman have some lungs on her. She picked me up in an Ulta before very reluctantly joining a camping trip to Braxton County. Jen didn't camp. She mentioned this many times - and proudly - on the drive to the woods. But if she had her sleeping pills, and her portable solar shower, and me, then maybe she could tolerate it for a night or two. She'd see. Her boyfriend and his buddies were pretty quiet on the topic and took the first chance they got to change the subject to the great fishing spot where they'd be spending the weekend. 3am rolls around and Jen, still sort of awake despite the sleeping pill, comes to terms with the fact that she will have to go out and pee in the woods, pulls me up onto her forehead, and laces up her brand new hiking boots to venture outside the tent. Then with the screaming. Listen, I know what I saw. She made up a lot of things (usually involving tarot, toxins, and how to communicate effectively in a romantic relationship), but when she shrieked that a nine foot tall monster with a pointy crested head and enormous red eyes was walking her way, well, she was being unusually accurate. In her haste to flee to the Rav4, she accidentally swiped me right off her head. And who should pick me up after all the hullabaloo died down but - you guessed it - the nine foot tall monster with the pointy crested head and enormous red eyes. Her name's Clarice and she is amazing. The locals refer to her as the Flatwoods Monster but to me she's just funny, gentle Clarice. Her giant glowing eyes are too big for me to be any use to her as a sleep mask, but she did enjoy just holding me and lightly stroking my satiny surface. You don't get to have a lot of nice things when you live in the middle of the woods. Good old Clairce. I hope she's doing okay out there.",
        "column1": "does not work"
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "08/02/2014",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "08/02/2018",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "05/25/2003",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "09/30/2021",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "12/25/2023",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "01/28/2008",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "07/14/2010",
    ...
    {
        "timestamp": "2024-10-18T04:25:10.618Z",
        "description": "green wrist watch",
        "name": "Timeless Timer",
        "origin": "Belden, CA, USA",
        "fulfillment": 10,
        "purpose": 3,
        "owner": "Simmply Scrubbing",
        "discardReason": "Submerged in water and torn asunder ",
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "04/05/2017",
        "factOne": "I proudly woke my owner up every night 1:35 am.",
        "factTwo": "My chirps could be heard through out the land. ",
        "story": "I remember the moment I hit the river—cold water rushed over my screen, slipping inside my circuits. I sputtered, tried to keep ticking, but everything became a blur. My display faded, numbers disappearing beneath the water's pull.\n\nLater, back on dry land, my owner rushed to save me. They removed my battery, hoping to dry me out. For a moment, I felt hope—a second chance. But without power, I lay there helpless, watching as my back cover was set aside. Then, disaster struck.\n\nThe cover disappeared—lost somewhere in the chaos of towels and tools. Now, I was exposed, vulnerable. No battery could help me now. Without the cover, my circuits felt naked, the protection I once had was gone.\n\nDays passed, and I waited, hoping they'd find the missing piece, that they'd bring me back to life. But instead, I was tossed into a drawer, forgotten.\n\nEventually, I was swept up with other odds and ends, carried to the trash. I wanted to cry out, to remind them of the time I’d faithfully kept. But without a battery, without my cover, I was nothing more than a shell of what I used to be.",
        "column1": "Does not work"
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "10/31/1992",
    ...
    {
        "timestamp": "2024-10-18T04:40:05.141Z",
        "description": "small black keyboard",
        "name": "Travel Keyboard",
        "origin": "Best Buy",
        "fulfillment": 8,
        "purpose": 4,
        "owner": "Alyss",
        "discardReason": "Left onsite at the end of a festival",
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "06/10/2023",
        "factOne": "With the right size fingers, it's physically impossible to write without typos on me. ",
        "factTwo": "My sticky 'a' key has caused untold hours of suffering debugging code.",
        "story": "I’ve been with Alyss for years now, tucked into her backpack, ready to spring into action whenever she needs to fix some last-minute issue at a festival. I’m small and compact, just the right size for her to squeeze into cramped spaces behind her installations or inside her van. She’ll hunch over me, fingers flying as she frantically debugs the latest glitch in her interactive art. The festival lights flash and music thumps in the distance, but Alyss doesn’t notice—she’s too busy pounding away at my tiny keys, desperate to solve the problem before the event is over. She’s missed entire shows, entire days of events, all because she’s trapped in front of me, fixing code she swears should work.\n\nBut here’s the thing—she doesn’t know it’s me. I’ve got a few sticky keys, nothing major, just a couple of little quirks that she hasn’t caught on to yet. Every time she presses that stubborn \"a\" or \"Shift\" key, it sometimes double-fires or doesn’t register at all. It’s led to hours of headaches for her, endless lines of broken code and baffling bugs. I watch as she pulls her hair out, cursing at the screen, blaming everything but the real culprit—me. If only she knew! Yet, I can’t help but feel a bit guilty and a bit relieved. After all, I’m the reason she’s missed so much of the festivals, but also the one who keeps her company through every frustrating hour.  She was my best friend! ",
        "recorded": "x",
        "column1": "Does not work"
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "08/31/2015",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "06/06/2024",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "02/02/2022 ",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "02/02/2006",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "05/04/2012",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "5/7/2098",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "What, like every week?",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "03/25/2023",
    ...
    {
        "timestamp": "2024-10-18T05:08:41.104Z",
        "description": "CDs",
        "name": "Burned CD: \"Just the Way You Are\" by Bruno Mars",
        "origin": "Albany, NY, USA",
        "fulfillment": 10,
        "purpose": 10,
        "owner": "Created by Sasha Cohen, given to Roxie Gallagher",
        "discardReason": "Relationship ended",
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "09/22/2015",
        "factOne": "Sasha's favorite lyric: \"And when you smile, the whole world stops and stares for awhile.\"",
        "factTwo": "Roxie is extremely shy. The whole world staring at her sounds absolutely terrifying. This is her least favorite lyric.",
        "story": "I was made for one purpose, and one purpose alone: to win the heart of Roxie Gallagher. Sasha stayed up all night trying to pick the perfect song: not the best song, per se, but one they'd sung together in the car and shared timid, flirting glances over. A song they both knew all the words to. One that, as soon as Roxie heard it, she'd know what it meant. She'd know that Sasha wanted to get back together with her, and that this time, she'd want to stay. This song was transferred to me from iTunes, burned into the fabric of my being. Sasha left my face unmarked by her usual sharpie artwork, so that I would be a surprise when Roxie put me into the CD player on her Honda Civic and let me sing. Sasha left me on Roxie's doorstep with a single red rose, and I fulfilled my purpose. I won Roxie's heart. For a while, I was cherished, held cradled in the CD player, played on every date and anniversary. But then the dates became filled with fighting instead of flirting, and the car changed hands from Roxie to her younger sister. I was ejected, both from the player and from Roxie's heart, and thrown into a trashbag with the rest of Sasha's romantic hopes. ",
        "recorded": "x",
        "column1": "Does not work"
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "01/01/2000",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "11/11/2024",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "06/10/2024",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "10/08/1997",
    ...
    },
    {
        ...
        "whatIsTheDateOfDisposalReceiptInTheFormatMonthdayyearForExample05252003": "05/17/2012",
