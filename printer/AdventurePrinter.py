...
class AdventurePrinter(object):
    ...
    def __create_character(self, character: CharacterSheet):
        ...
        pdf.image(
            "/home/admin/explorey/printer/resources/charactersheet.jpg", 15, 10, 75, 260
        )
        pdf.set_font("Arial", "B", 16)
        ...
        pdf.cell(75, 4, ln=1)
        pdf.cell(0, 8, f"Main Quest:", align="L", ln=1)
        pdf.cell(75, 4, ln=1)
        pdf.cell(6, 6)
        pdf.multi_cell(0, 6, f"{character.main_quest}", align="L")
        pdf.cell(75, 4, ln=1)
        pdf.cell(0, 8, f"Quest Stamps:", align="L", ln=1)
        pdf.cell(75, 4, ln=1)
        pdf.set_font("Arial", "", 9)
        pdf.cell(28, 4, f"Blessing of Onions", align="L")
        pdf.cell(48, 4, f"Blessing of Potatoes", align="L", ln=1)
        pdf.cell(28, 4, f"+3 Sneakiness", align="L")
        pdf.cell(48, 4, f"+3 Craftiness", align="L", ln=1)
        pdf.cell(28, 4, f"+1 Life", align="L")
        pdf.cell(48, 4, f"+1 Life", align="L", ln=1)
        pdf.cell(75, 14, ln=1)
        pdf.cell(28, 4, f"Blessing of Rutabaga", align="L")
        pdf.cell(48, 4, f"Blessing of Carrots", align="L", ln=1)
        pdf.cell(28, 4, f"+3 Scrappiness", align="L")
        pdf.cell(48, 4, f"+3 Fabulousness", align="L", ln=1)
        pdf.cell(28, 4, f"+1 Life", align="L")
        pdf.cell(48, 4, f"+1 Life", align="L", ln=1)
        pdf.cell(75, 14, ln=1)
