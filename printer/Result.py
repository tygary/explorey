...
ITEMS = [
    [
        "Whiffle Whistle",
        "A small whistle that emits a faint, melodious tune when blown",
        "Sneakiness +1",
    ],
    [
        "Tickle Gloves",
        "A pair of gloves that tickle anyone they touch, causing uncontrollable laughter",
        "Scrappiness +1",
    ],
    [
        "Goblin Goggles",
        "Goggles that allow the wearer to see through walls, but only when they have been blessed by a goblin",
        "Craftiness +1",
    ],
    [
        "Cape of Dramatic Flair",
        "A flowing cape that billows dramatically even in the absence of wind",
        "Fabulousness +1",
    ],
    [
        "Bag of Endless Snacks",
        "A small bag that always produces the adventurer's favorite snack, no matter how many times it's emptied",
        "Magical Ability: Infinite Snacking",
    ],
    [
        "Socks of Stealth",
        "Magical socks that muffle the wearer's footsteps, making them nearly silent",
        "Sneakiness +2",
    ],
    [
        "Bouncy Boots",
        "A pair of boots that allow the wearer to jump higher and bounce around like a kangaroo",
        "Scrappiness +2",
    ],
    [
        "Wand of Whimsy",
        "A wand that can turn mundane objects into amusing and harmless creatures for a short time",
        "Craftiness +2",
    ],
    [
        "Charm Bracelet of Charm",
        "A bracelet that enhances the wearer's charisma, making them more persuasive and charismatic",
        "Fabulousness +2",
    ],
    [
        "Singing Sword",
        "A magical sword that sings catchy tunes while in combat, boosting morale and confusing enemies",
        "Magical Ability: Battle Serenade",
    ],
    [
        "Gloves of Butterfingers",
        "A pair of gloves that make the wearer incredibly clumsy, but also surprisingly good at juggling",
        "Sneakiness -1, Craftiness +1",
    ],
    [
        "Wand of Wackiness",
        "A wand that creates amusing and unpredictable magical effects when waved around",
    ...
    [
        ...
        "A goblet that fills with laughter instead of liquid, spreading joy and amusement to those who drink from it",
        "Fabulousness +2",
    ],
    [
        "Invisible Ink Pen",
        "A pen that writes with invisible ink, which can only be revealed by a magical feather duster",
        "Magical Ability: Invisible Writing",
    ],
    [
        "Mirror of Ridiculous Reflections",
        "A mirror that distorts the reflections of those who look into it, making them appear comically exaggerated",
        "Craftiness +1, Fabulousness +1",
    ],
    [
        "Tik-Tok Timepiece",
        "A pocket watch that manipulates time in small increments, causing minor time loops and déjà vu moments",
        "Magical Ability: Time Manipulation - Max 5 seconds",
    ],
    [
        "Hat of Hilarity",
        "A hat that tells funny jokes and humorous anecdotes when worn, creating a jovial atmosphere",
        "Fabulousness +1",
    ],
    [
        "Sneaky Shoes",
        "A pair of shoes that muffle all sounds when the wearer is sneaking, but also emit an embarrassing squeak when walking normally",
        "Sneakiness +2, Faulousness -1",
    ],
    [
        "Portable Cloud Pillow",
        "A magical pillow that creates a fluffy cloud to rest on, providing comfort and relaxation anywhere",
        "Craftiness +1",
    ],
    [
        "Cape of Confusion",
        "A cape that shrouds the wearer in an illusion of multiple copies, making it difficult for enemies to determine the real one",
        "Magical Ability: Illusory Clones - Max 2 clones for 1 minute",
    ],
    [
        "Giggling Gauntlets",
        "Magical gauntlets that emit uncontrollable giggles when the wearer clenches their fists",
        "Scrappiness +1",
    ],
    [
        "Quill of Quirkiness",
        "A quill that writes with its own unique personality, adding witty remarks and sarcastic comments to anything written",
        "Craftiness +1",
    ],
    [
        "Cloak of the Chameleon",
        "A cloak that changes its color to match the surroundings, but occasionally gets stuck in an embarrassing pattern",
        "Sneakiness +1",
    ],
    [
        "Dazzling Diva Tiara",
        "A tiara that enhances the wearer's stage presence, making them shine brighter and captivating their audience",
        "Fabulousness +1",
    ],
    [
        "Enchanted Feather Duster",
        "A feather duster that reveals hidden messages and secrets when used to brush away dust",
        "Magical Ability: Dust Divination",
    ],
    [
        "Potion of Perpetual Peculiarity",
        "A potion that causes the drinker to experience a random comical physical transformation for a short duration",
    ...
    [
        ...
        "A cloak that grants the wearer the ability to turn invisible, but also emits sporadic bursts of colorful confetti",
        "Sneakiness +2",
    ],
    [
        "Wand of Whimsical Whistling",
        "A wand that produces catchy tunes when waved, causing those nearby to uncontrollably tap their feet and hum along",
        "Craftiness +2",
    ],
    [
        "Goblet of Endless Nourishment",
        "A goblet that magically refills itself with a hearty and delicious soup, perfect for never-ending feasts",
        "Magical Ability: Infinite Soup",
    ],
    [
        "Cape of Clumsy Levitation",
        "A cape that allows the wearer to levitate a few feet off the ground but also makes them float in comically erratic directions",
        "Fabulousness +2, Sneakiness -1",
    ],
    [
        "Jester's Juggling Balls",
        "A set of colorful juggling balls that never drop when thrown, even by those with no juggling skills",
        "Scrappiness +1, Craftiness +1",
    ],
    [
        "Chatterbox Amulet",
        "An amulet that grants the wearer the ability to speak and understand the language of animals, but also makes them talkative and gossip-loving",
        "Magical Ability: Animal Talk",
    ],
    [
        "Orb of Unpredictable Transformation",
        "An orb that transforms any object touched into a random, unexpected item for a short time",
        "Magical Ability: Transformative Chaos",
    ],
    [
        "Laughing Boots",
        "Boots that make a distinctive giggling sound with each step, causing everyone nearby to chuckle",
        "Sneakiness +1, Fabulousness +1",
    ],
    [
        "Cane of Comical Conjuring",
        "A cane that, when tapped on the ground, produces amusing and harmless magical effects, like squirting water or confetti showers",
        "Craftiness +2",
    ],
    [
        "Quizzical Crystal Ball",
        "A crystal ball that answers questions with riddles and enigmatic messages, rather than straightforward answers",
        "Magical Ability: Riddling Divination",
    ],
    [
        "Gloves of Mischievous Manipulation",
        "A pair of gloves that allow the wearer to subtly influence the thoughts and actions of others, but also cause harmless pranks to occur around them",
        "Craftiness +2",
    ],
    [
        "Whistle of Wandering",
        "A magical whistle that, when blown, summons a playful breeze that guides the adventurer to the nearest hidden treasure",
        "Magical Ability: Treasure Tracing",
    ],
    [
        "Spoon of Spontaneous Spilling",
        "A spoon that magically causes the food it touches to spill and splatter uncontrollably",
        "Craftiness +1, -1 Sneakiness",
    ],
    [
        "Shrieking Shoes",
        "A pair of shoes that emit a loud, ear-piercing shriek with every step, making sneaking nearly impossible.  But they're so stylish!",
        "Sneakiness -2, Fabulousness +2",
    ],
    [
        "Ring of Misplaced Trinkets",
        "A ring that constantly causes small objects in the vicinity to disappear and reappear in unexpected places",
        "Craftiness +1, Fabulousness -1",
    ],
    [
        "Belt of Unintentional Inflation",
        "A belt that, when worn, causes the wearer to slowly inflate like a balloon until someone lets the air out",
        "Fabulousness +1, Scrappiness -1",
    ],
    [
        "Socks of Slipping",
        "A pair of socks that make the wearer's feet incredibly slippery, resulting in frequent accidental falls",
        "Sneakiness -1",
    ],
    [
        "Cursed Comb",
        "A comb that tangles hair into impossible knots and makes it resistant to any attempts at styling",
        "Fabulousness -2",
    ],
    [
        "Jar of Never-Ending Sneezes",
        "A jar that, when opened, releases an endless stream of comically loud and frequent sneezes",
        "Scrappiness +1, Craftiness -1",
    ],
    [
        "Ring of the Clumsy Juggler",
        "A ring that compels the wearer to juggle random objects whenever they feel nervous or anxious",
        "Scrappiness +1, Sneakiness -1",
    ],
    [
        "Bag of Unreliable Holding",
        "A bag with a tendency to randomly teleport or spit out items when least expected",
    ...
    [
        "Cursed Mirror",
        "A mirror that reflects the viewer's image with amusing distortions, making them appear silly and exaggerated",
        "Fabulousness +1",
    ],
    [
        "Chattering Chalice",
        "A chalice that talks incessantly, narrating everything happening around it in a comically exaggerated manner",
        "Craftiness +1, Sneakiness -1",
    ],
    [
        "Gloves of Butterfingers",
        "A pair of gloves that make the wearer incredibly clumsy, causing them to frequently drop and fumble objects",
        "Scrappiness -2",
    ],
    [
        "Cloak of Unintentional Invisibility",
        "A cloak that turns the wearer invisible, but only when nobody is looking in their direction",
        "Sneakiness +1, Fabulousness -1",
    ],
    [
        "Amulet of Awkward Encounters",
        "An amulet that attracts embarrassing and awkward situations, making social interactions more difficult",
        "Fabulousness -2",
    ],
    [
        "Cursed Dice",
        "A set of dice that always roll low numbers, making success in games of chance nearly impossible",
        "Scrappiness -1",
    ],
    [
        "Wand of Whacky Wonders",
        "A wand that produces wild and uncontrollable magical effects, often with unintended and chaotic consequences",
    ...
    [
        "Cloak of Magnetism",
        "A cloak that attracts random metallic objects, causing them to stick to the wearer at the most inconvenient times",
        "Sneakiness -1",
    ],
    [
        "Hat of Distracting Hats",
        "A hat that spawns multiple smaller hats that orbit around the wearer's head, creating a distracting spectacle",
        "Fabulousness +1",
    ],
    [
        "Goblin's Grin Mask",
        "A mask that permanently freezes the wearer's face into a mischievous goblin grin, making it difficult to be taken seriously in serious situations",
        "Fabulousness +1, Scrappiness -1",
    ],
]
...
PUNISHMENTS = [
    ...
    [
        "Loudspeaker Voice",
        "The adventurer's voice becomes amplified to a deafening volume, causing everything they say to be heard by everyone within a mile.",
        "-2 Sneakiness",
    ],
    [
        "Game Show Voice",
        "The adventurer's voice becomes permanently altered to the voice of a Game Show Host.",
        "+1 D6 to any roll when using the Game Show Voice. -1 D6 if you do not.",
    ],
    [
        "Curse of the Bumbling Blunder",
        "The adventurer's future attempts at being sneaky turn into a series of clumsy and noisy mishaps.",
        "-2 Sneakiness",
    ],
    [
        "Forgetful Fingers",
        "The adventurer's hands become unusually uncoordinated, resulting in a string of failed attempts at scrappy actions.",
        "-2 Scrappiness",
    ],
    [
        "Slippery Slope",
        "The adventurer's sneaky maneuvers are hindered by an unfortunate tendency to slip and slide, making them prone to comedic falls.",
        "-2 Sneakiness",
    ],
    [
        "Pratfall Master",
        "The adventurer's scrappy actions often result in them tripping, stumbling, and performing unintentional acrobatic feats.",
        "-2 Scrappiness, +1 Fabulousness",
    ],
    [
        "Crafting Clumsiness",
        "No matter how hard the adventurer tries, their crafty creations always end up being comically off-balance or structurally unsound.",
        "-2 Craftiness",
    ],
    [
        "Mischievous Curse",
        "You stumble into a cursed mushroom patch and are now afflicted with a mischievous curse. Your voice can only create silly sound effects. ",
        "Speak only with silly sound effects",
    ],
    [
        "Gravity Shuffle",
        "You accidentally trigger a magical device that alters gravity in your immediate vicinity. Now, whenever you move, you experience unpredictable changes in gravity that make your movements awkward and uncoordinated.",
        "-2 Scrappiness",
    ],
    [
        "Clumsy Potion",
        "While rummaging through an box, you accidentally knock over a vial labeled 'Clumsy Elixir.' As you inhale the fumes, you suddenly find yourself becoming incredibly clumsy, causing frequent mishaps and dropped items.",
        "-2 Craftiness",
    ],
    [
        "Tickle Curse",
        "A mischievous sprite decides to play a prank on you by casting a tickle curse. From now on, at random intervals, you uncontrollably burst into fits of uncontrollable laughter, making it difficult to concentrate on tasks.",
        "-2 Craftiness",
    ],
    [
        "Fashion Disaster",
        "You unknowingly put on a cursed garment that causes your clothing to become mismatched and outlandish. This makes it challenging to maintain a fabulous appearance and leaves others questioning your sense of style.",
        "-2 Fabulousness",
    ],
    [
        "Bewitched Shadows",
        "You inadvertently stumble into an enchanted grove where your shadow takes on a life of its own. It becomes mischievous and frequently sabotages your sneaky attempts, making it difficult to remain unnoticed.",
        "-2 Sneakiness",
    ],
    [
        "Potion of Uncontrollable Giggles",
        "You mistakenly ingest a potion meant for a giggling competition, causing you to burst into uncontrollable fits of giggles at inappropriate moments. This makes it difficult to maintain a serious demeanor or execute sneaky actions.",
        "-2 Sneakiness",
    ],
    [
        "Squeaky Shoes",
        "As you step on an ancient trap, your shoes magically transform into squeaky toys. Your attempts at stealth now draw attention due to the constant squeaking sound they emit.",
        "-2 Sneakiness",
    ],
    [
        "Butterfly Whispers",
        "An enchanted butterfly lands on your shoulder and whispers distracting and nonsensical information into your ear. Its constant chatter hampers your concentration, making it harder to execute sneaky actions.",
        "-2 Sneakiness",
    ],
    [
        "Singing Spellbook",
        "While exploring a magical library, you inadvertently open a book that contains a singing spell. The spellbook now insists on serenading you at every opportunity, causing distractions and making it challenging to focus on tasks.",
        "-2 Craftiness",
    ],
    [
        "Inflated Ego",
        "You stumble upon a magical artifact that temporarily inflates your ego to enormous proportions. Your arrogance hampers your ability to work well with others, leading to reduced scrappiness in team interactions.",
        "-2 Scrappiness",
    ],
    [
...
DEATHS = [
    [
        ...
        "You have died.  Make a new character...",
    ],
    [
        "Raging Munchkins",
    ...
    [
        ...
        "You have lost the adventuring spirit.  Make a new character...",
    ],
    [
    ...
    [
        ...
        "You have lost the adventuring spirit. Make a new character... Or go dance it off.",
    ],
    [
