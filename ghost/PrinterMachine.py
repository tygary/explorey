...
TUBE_INNER_PIXELS = list(range(TUBE_INNER_START_PIXEL, TUBE_INNER_NUM_PIXELS))
TUBE_OUTER_PIXELS = list(range(TUBE_OUTER_START_PIXEL, TUBE_OUTER_NUM_PIXELS))
DIORAMA_WALL_PIXELS = list(range(DIORAMA_WALL_START_PIXEL, DIORAMA_WALL_NUM_PIXELS))
DIORAMA_FIBER_PIXELS = list(range(DIORAMA_FIBER_START_PIXEL, DIORAMA_FIBER_NUM_PIXELS))
