...
class AdventurePrinter(object):
    ...
    def __create_character(self, character: CharacterSheet):
        ...
        pdf.cell(30, 4, f"Blessing of Onions", align="L")
        pdf.cell(60, 4, f"Blessing of Potatoes", align="L", ln=1)
        pdf.cell(30, 4, f"+3 Sneakiness", align="L")
        pdf.cell(60, 4, f"+3 Craftiness", align="L", ln=1)
        pdf.cell(30, 4, f"+1 Life", align="L")
        pdf.cell(60, 4, f"+1 Life", align="L", ln=1)
        pdf.cell(75, 14, ln=1)
        pdf.cell(30, 4, f"Blessing of Rutabaga", align="L")
        pdf.cell(60, 4, f"Blessing of Carrots", align="L", ln=1)
        pdf.cell(30, 4, f"+3 Scrappiness", align="L")
        pdf.cell(60, 4, f"+3 Fabulousness", align="L", ln=1)
        pdf.cell(30, 4, f"+1 Life", align="L")
        pdf.cell(60, 4, f"+1 Life", align="L", ln=1)
        pdf.cell(75, 14, ln=1)
