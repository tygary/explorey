...
class BankruptcyConfirmationScreen(Screen):
    def __init__(self, on_finalize_bankruptcy, **kwargs):
        ...
        self.account_image = Image(size_hint=(1, 0.1), width=400, allow_stretch=True, keep_ratio=True, pos_hint={'center_x': 0.5, 'y': 0.2})
        self.beans_owed_label = Label(font_size="18sp", size_hint=(1, 0.05), pos_hint={'center_x': 0.5, 'y': 0.25}, halign='center', valign='middle')
