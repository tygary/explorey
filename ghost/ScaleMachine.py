    ...
    def _update_light_routines(self):
        ...
        if self.mode is MODE_OFF:
            ...
            self.light_routines = [
                ...
                Routines.WaveRoutine(self.pixels, POWER_BOARD_PIXELS, [Colors.red, Colors.green, Colors.blue], wave_wait_time=10, pixel_wait_time=0, should_override=True, brightness=0.8, can_reverse=False),
