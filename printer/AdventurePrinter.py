...
class AdventurePrinter(object):
    ...
    def __create_character(self, character: CharacterSheet):
        ...
        pdf.set_font('Arial', '', 12)
        pdf.cell(6, 10)
        pdf.cell(0, 10, f"Name:_________________", align='L', ln=1)
        pdf.cell(6, 10)
        pdf.cell(0, 10, f"Species: {character.species}", align='L', ln=1)
        pdf.cell(6, 10)
        pdf.cell(0, 10, f"Profession: {character.class_name}", align='L', ln=1)
        pdf.ln()
        pdf.ln()
        pdf.cell(0, 6, f"Skills:", align='L', ln=1)
        pdf.cell(90, 10, ln=1)
        pdf.cell(45, 10, f"{character.dex}", align='C')
        pdf.cell(45, 10, f"{character.wis}", align='C', ln=1)
        pdf.cell(45, 6, f"Sneakiness", align='C')
        pdf.cell(45, 6, f"Craftiness", align='C', ln=1)
        pdf.cell(90, 10, ln=1)
        pdf.cell(45, 10, f"{character.con}", align='C')
        pdf.cell(45, 10, f"{character.cha}", align='C', ln=1)
        pdf.cell(45, 6, f"Scrappiness", align='C')
        pdf.cell(45, 6, f"Fabulousness", align='C', ln=1)
        pdf.ln()
