...
class AdventurePrinter(object):
    ...
    def __create_character(self, character: CharacterSheet):
        ...
        pdf.cell(37, 8, f"{character.dex}", align='C')
        pdf.cell(37, 8, f"{character.wis}", align='C', ln=1)
        pdf.set_font('Arial', '', 12)
        pdf.cell(37, 6, f"Sneakiness", align='C')
        pdf.cell(37, 6, f"Craftiness", align='C', ln=1)
        pdf.cell(75, 8, ln=1)
        pdf.set_font('Arial', 'B', 14)
        pdf.cell(37, 8, f"{character.con}", align='C')
        pdf.cell(37, 8, f"{character.cha}", align='C', ln=1)
        pdf.set_font('Arial', '', 12)
        pdf.cell(37, 6, f"Scrappiness", align='C')
        pdf.cell(37, 6, f"Fabulousness", align='C', ln=1)
        pdf.ln()
