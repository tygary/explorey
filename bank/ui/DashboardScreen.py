...
class DashboardScreen(Screen):
    def __init__(self, atm=None, **kwargs):
        ...
        button_labels = ['Open Account', 'Withdraw', 'Deposit', 'Transfer', 'Check Balance', 'Become a Teller', 'File for Bankruptcy', 'Buy Shares']
        for label in button_labels:
            ...
            if label == 'Deposit':
                ...
                btn.bind(on_press=self.go_to_buy_shares)
    ...
    def go_to_buy_shares(self, instance):
        self.manager.current = 'buy_shares'
