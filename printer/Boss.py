...
BOSSES = [
    ...
    # ],
    [
        "The Great Abominable Snow Yeti - Shadow-san",
        "In a blizzard-ravaged valley, your party discovers the legendary dojo of Shadow-san, the Abominable Snow Yeti. This noble yet ferocious warrior guards a sacred treasure with unmatched samurai skills.",
        "Blade of the Blizzard: As you approach, Shadow-san brandishes a sword of pure ice, launching a flurry of razor-sharp icicles. If anyone in your party has a Scrappiness score of 18 or higher, you successfully dodge the icicle barrage. Otherwise, your party suffers severe frost wounds.",
        "Duel of Honor: Challenged by Shadow-san to a one-on-one duel, you must face the yeti samurai. Use a combat ability or a mystical weapon to match his skill. Failing to meet the challenge results in a devastating blow from his ice blade.",
        "Ancient Samurai Riddle: Shadow-san poses a riddle:\nIn marble halls as white as milk,\nLined with skin as soft as silk,\nWithin a fountain crystal clear\nA golden apple doth appear.\nNo doors are there to this stronghold,\nYet thieves break in and steal the gold.\n Solve it using wisdom or a lore-specific item to prove your worthiness. Failing to solve the riddle leads to the yeti's disdain and a forceful expulsion from the dojo.",
        "If you fail two or more of these challenges, then your party is vanquished, and you retreat with severe injuries. If Shadow-san is honored by your bravery but you fail on other challenges, you are allowed a safe exit with a small token of respect. Succeeding in all three challenges grants you access to Shadow-san's treasure. Gain a legendary samurai artifact and increase each party member's highest skill by +2.",
    ]
]
